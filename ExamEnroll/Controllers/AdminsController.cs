...
namespace ExamEnroll.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Aid,UserName,Password")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Aid,UserName,Password")] Admin admin)
        {
            if (ModelState.IsValid)
            {
